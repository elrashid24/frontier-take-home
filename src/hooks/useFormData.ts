...
const mockResponse = {
  ...
  job: {
    title: 'Remote Customer Support Operator',
  },
  sections: [
    {
      id: 'about',
      ...
      content: [
        {
          ...
          metadata: {
            options: [
              ...
              {
                label: 'Eastern Min (inc. Fuzhounese)',
              ...
              {
                label: 'Malay (inc. Malaysian and Indonesian)',
              ...
              {
                label: 'Southern Min (incl. Hokkien and Teochew)',
              ...
              {
                label: 'Wu (e.g. Shanghainese)',
                value: 'Wu (e.g. Shanghainese)',
              },
              {
                label: 'Xhosa',
                value: 'Xhosa',
              ...
              {
                label: 'Xiang (Hunanese)',
                value: 'Xiang (Hunanese)',
              },
              {
                label: 'Yoruba',
                value: 'Yoruba',
          ...
          question_text: "Select which languages you're fluent in",
        },
        {
          id: 'workspace',
          type: 'boolean',
          ...
          question_text: 'Do you have access to a private workspace?',
        },
        {
          id: 'experience',
          type: 'textarea',
          ...
          question_text: "What's your experience working in Customer Service?",
        },
        {
          id: 'hours_on_project',
          type: 'text',
          ...
          question_text:
            'How many hours per week could you dedicate to the project, including training?',
        },
      ],
    },
  ],
